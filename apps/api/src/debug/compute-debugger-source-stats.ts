...
interface DebuggerBarChartStats {
  readonly id: string;
  readonly titleKey:
...
interface DebuggerTimelineBucket {
  readonly label: string;
...
function computeTimelineBuckets(
  events: readonly DebugEvent[],
  bucketCount = 10,
