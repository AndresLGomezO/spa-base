...
interface MainViewDesignerComponentRowPanelHeaderMenuProps {
  readonly rowRef: ComponentRowRef;
}

export function MainViewDesignerComponentRowPanelHeaderMenu({
  rowRef,
}: MainViewDesignerComponentRowPanelHeaderMenuProps) {
