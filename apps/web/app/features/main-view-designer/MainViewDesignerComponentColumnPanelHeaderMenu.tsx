...
interface MainViewDesignerComponentColumnPanelHeaderMenuProps {
  readonly columnRef: ComponentColumnRef;
}

export function MainViewDesignerComponentColumnPanelHeaderMenu({
  columnRef,
}: MainViewDesignerComponentColumnPanelHeaderMenuProps) {
