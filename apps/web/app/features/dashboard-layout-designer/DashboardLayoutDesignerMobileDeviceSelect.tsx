...
interface DashboardLayoutDesignerMobileDeviceSelectProps {
...
export function DashboardLayoutDesignerMobileDeviceSelect({
  className,
}: DashboardLayoutDesignerMobileDeviceSelectProps) {
