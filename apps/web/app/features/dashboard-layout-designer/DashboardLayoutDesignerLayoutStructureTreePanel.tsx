...
interface DashboardLayoutDesignerLayoutStructureTreePanelProps {
  readonly panelTitle?: string;
  readonly onInsert: (anchor: InsertAnchor) => void;
}

export function DashboardLayoutDesignerLayoutStructureTreePanel({
  panelTitle,
  onInsert,
}: DashboardLayoutDesignerLayoutStructureTreePanelProps) {
  const {
    editor,
