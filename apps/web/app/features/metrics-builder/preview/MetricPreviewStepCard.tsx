...
import type { MetricPreviewStep } from "./metric-preview-types.js";
...
interface MetricPreviewStepCardProps {
  readonly step: MetricPreviewStep;
  readonly mode: "overview" | "details" | "advanced";
  readonly showConnector?: boolean;
}

export function MetricPreviewStepCard({
  step,
  mode,
  showConnector = false,
}: MetricPreviewStepCardProps) {
