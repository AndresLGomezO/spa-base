...
const MetricsRowDesignerStructureSessionContext =
  createContext<MetricsRowDesignerStructureSessionContextValue | null>(null);
...
export function MetricsRowDesignerStructureSessionProvider({
  children,
}: {
...
export function useOptionalMetricsRowDesignerStructureSession(): MetricsRowDesignerStructureSessionContextValue | null {
  return useContext(MetricsRowDesignerStructureSessionContext);
}

export function useMetricsRowDesignerStructureSession(): MetricsRowDesignerStructureSessionContextValue {
  const context = useContext(MetricsRowDesignerStructureSessionContext);
  if (!context) {
    throw new Error(
      "useMetricsRowDesignerStructureSession must be used within MetricsRowDesignerStructureSessionProvider",
    );
  }
  return context;
}
