...
interface MetricsRowDesignerPreviewThemeSelectProps {
  readonly className?: string;
}

export function MetricsRowDesignerPreviewThemeSelect({
  className,
}: MetricsRowDesignerPreviewThemeSelectProps) {
  const { t } = useTranslation("common");
  const { previewColorScheme, setPreviewColorScheme } = useMetricsRowDesigner();
