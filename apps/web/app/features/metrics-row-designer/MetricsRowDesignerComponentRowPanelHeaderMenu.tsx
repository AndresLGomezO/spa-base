...
interface MetricsRowDesignerComponentRowPanelHeaderMenuProps {
  readonly rowRef: ComponentRowRef;
}

export function MetricsRowDesignerComponentRowPanelHeaderMenu({
  rowRef,
}: MetricsRowDesignerComponentRowPanelHeaderMenuProps) {
