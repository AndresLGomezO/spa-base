...
interface ItemListDesignerPreviewThemeSelectProps {
  readonly className?: string;
}

export function ItemListDesignerPreviewThemeSelect({
  className,
}: ItemListDesignerPreviewThemeSelectProps) {
  const { t } = useTranslation("common");
  const { previewColorScheme, setPreviewColorScheme } = useItemListDesigner();
