...
interface SidebarLayoutDesignerLayoutStructureTreePanelProps {
  readonly panelTitle?: string;
  readonly onInsert: (anchor: InsertAnchor) => void;
}

export function SidebarLayoutDesignerLayoutStructureTreePanel({
  panelTitle,
  onInsert,
}: SidebarLayoutDesignerLayoutStructureTreePanelProps) {
