...
interface SidebarLayoutDesignerComponentColumnPanelProps {
  readonly columnRef: ComponentColumnRef;
}

export function SidebarLayoutDesignerComponentColumnPanel({
  columnRef,
}: SidebarLayoutDesignerComponentColumnPanelProps) {
