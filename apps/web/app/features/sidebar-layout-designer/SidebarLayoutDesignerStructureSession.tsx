...
interface SidebarLayoutDesignerStructureSessionContextValue {
...
const SidebarLayoutDesignerStructureSessionContext =
  createContext<SidebarLayoutDesignerStructureSessionContextValue | null>(null);
...
export function SidebarLayoutDesignerStructureSessionProvider({
  children,
}: {
  ...
  const value = useMemo(
    (): SidebarLayoutDesignerStructureSessionContextValue => ({
      focusedRow,
      setFocusedRow,
      focusedColumn,
      setFocusedColumn,
  ...
  return (
    <SidebarLayoutDesignerStructureSessionContext.Provider value={value}>
      <StructurePanelSync />
      {children}
    </SidebarLayoutDesignerStructureSessionContext.Provider>
  );
}

export function useOptionalSidebarLayoutDesignerStructureSession(): SidebarLayoutDesignerStructureSessionContextValue | null {
  return useContext(SidebarLayoutDesignerStructureSessionContext);
}

export function useSidebarLayoutDesignerStructureSession(): SidebarLayoutDesignerStructureSessionContextValue {
  const context = useContext(SidebarLayoutDesignerStructureSessionContext);
  if (!context) {
    throw new Error(
      "useSidebarLayoutDesignerStructureSession must be used within SidebarLayoutDesignerStructureSessionProvider",
    );
  }
  return context;
}
