...
import type { FormulaPreviewStep } from "./formula-preview-types.js";

const ICONS = {
  purpose: FunctionSquare,
  inputs: SlidersHorizontal,
  output: Layers,
  expression: Braces,
} as const;

interface FormulaPreviewStepCardProps {
  readonly step: FormulaPreviewStep;
  readonly mode: "overview" | "details" | "advanced";
  readonly showConnector?: boolean;
}

export function FormulaPreviewStepCard({
  step,
  mode,
  showConnector = false,
}: FormulaPreviewStepCardProps) {
