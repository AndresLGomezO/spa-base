...
interface DetailViewDesignerComponentColumnPanelProps {
  readonly columnRef: ComponentColumnRef;
}

export function DetailViewDesignerComponentColumnPanel({
  columnRef,
}: DetailViewDesignerComponentColumnPanelProps) {
