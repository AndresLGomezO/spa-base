...
export function motionPresetEditorLabels(
  ...
  return {
    ...
    press: t("entity.viewSettings.motionPress"),
    pressColor: t("entity.viewSettings.motionPressColor"),
    pressDurationMs: t("entity.viewSettings.motionPressDuration"),
    pressScale: t("entity.viewSettings.motionPressScale"),
    pressOpacity: t("entity.viewSettings.motionPressOpacity"),
    pressGlowBlurPx: t("entity.viewSettings.motionPressGlowBlur"),
