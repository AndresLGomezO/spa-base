      ...
      <div className="flex flex-col gap-3">
        <label className="flex items-center gap-2 text-sm">
          <Checkbox
            ...
            onChange={(event) =>
              updateConfig({ enableSearch: event.target.checked })
            }
          />
          <span>{t("viewFilterComponents.enableSearch")}</span>
        </label>
        {enableSearch ? (
          <>
            ...
            <label className="flex flex-col gap-1">
              <FieldLabel>
                {t("viewFilterComponents.searchPlaceholder")}
              </FieldLabel>
              <Input
                value={config.searchPlaceholder ?? ""}
                onChange={(event) =>
                  updateConfig({ searchPlaceholder: event.target.value })
                }
              />
            </label>
          </>
        ...
        <label className="flex items-center gap-2 text-sm">
          <Checkbox
            ...
            onChange={(event) =>
              updateConfig({ enableFilters: event.target.checked })
            }
          />
