...
export function LoginPage() {
  ...
  return (
    <div className="from-primary-100/40 via-background to-background dark:from-primary-950/30 relative flex min-h-dvh items-center justify-center bg-gradient-to-br px-4 py-12 pt-[max(3rem,env(safe-area-inset-top))] pb-[max(3rem,env(safe-area-inset-bottom))]">
