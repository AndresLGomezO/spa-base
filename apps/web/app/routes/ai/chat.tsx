...
import { useAiSpendActionGuard } from "../../features/ai-spend/use-ai-spend-action-guard";
import {
  getAiJob,
  isAiSpendLimitError,
  submitAiChat,
...
export default function AiChatRoute() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-4">
      ...
      {submitMutation.isError && !isAiSpendLimitError(submitMutation.error) ? (
        <Alert>{t("aiChat.submitError")}</Alert>
      ) : null}
