...
export interface StyleRulesEditorLabels {
  ...
  readonly styleDefaultValue?: string;
  readonly styleBreakpoints?: string;
  readonly styleBreakpointsHint?: string;
  readonly styleAddBreakpoint?: string;
  readonly styleEditBreakpoint?: string;
  readonly styleSaveBreakpoint?: string;
  readonly styleBreakpointScreen?: string;
  readonly styleBreakpointEmpty?: string;
  readonly styleBreakpointCancel?: string;
  readonly styleBreakpointBack?: string;
  readonly styleBreakpointClear?: string;
  readonly styleBreakpointShortBase?: string;
  readonly styleBreakpointShortSm?: string;
  readonly styleBreakpointShortMd?: string;
  readonly styleBreakpointShortLg?: string;
  readonly styleBreakpointShortXl?: string;
