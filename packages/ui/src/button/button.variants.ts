export const buttonVariants = {
  ...
  ai: [
    ...
    "bg-[linear-gradient(var(--color-background),var(--color-background)),linear-gradient(90deg,var(--color-primary),#8b5cf6_50%,#22d3ee)]",
    ...
    "hover:bg-[linear-gradient(color-mix(in_oklab,var(--color-primary)_8%,var(--color-background)),color-mix(in_oklab,var(--color-primary)_8%,var(--color-background))),linear-gradient(90deg,var(--color-primary),#8b5cf6_50%,#22d3ee)]",
