...
**Related:** [admin-dashboard-guide.md](./admin-dashboard.md), [theme-and-tenant-branding-guide.md](./theme-and-tenant-branding.md), [firestore-collections-guide.md](./firestore-collections.md)
...
For palette presets, semantic overrides, and CSS variable application, see [theme-and-tenant-branding-guide.md](./theme-and-tenant-branding.md).
