...
**Documentation:** [theme-and-tenant-branding-guide.md](./theme-and-tenant-branding.md) · [packages/theme/README.md](../../packages/theme/README.md)

Logo upload uses Firebase Admin Storage. See [gcs-storage-guide.md](./gcs-storage.md).
...
- [theme-and-tenant-branding-guide.md](./theme-and-tenant-branding.md)
