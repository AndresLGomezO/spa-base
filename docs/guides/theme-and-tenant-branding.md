...
**Platform UI:** [admin-dashboard-guide.md](./admin-dashboard.md) § Appearance  
**Logo storage:** [gcs-storage-guide.md](./gcs-storage.md)
...
Implemented token items are covered above.
