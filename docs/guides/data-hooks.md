...
**[data-hook-definition-json.md](../reference/data-hook-definition.md)** is the
...
Base path `/api/data-hooks` — see the [spec §9](../reference/data-hook-definition.md#9-api-and-permissions)
...
- **Phase 4** — authoritative specification document ([data-hook-definition-json.md](../reference/data-hook-definition.md)).
...
- [hooks-system-guide.md](./hooks-system.md) — dispatch architecture (system + dynamic hooks)
- [entity-definition-json.md](../reference/entity-definition.md) — entity schemas hooks reference
- rates-data-hooks-gap-analysis.md — Rates tenant automation backlog (example domain)
