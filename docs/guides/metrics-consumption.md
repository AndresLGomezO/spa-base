...
Implemented read API for pre-aggregated metric rows. Write pipeline: aggregations.md.
...
1. `POST /api/metric-definitions/:id/backfill` (initial or version-bump backfill per [aggregations-ops.md](./aggregations.md)).
