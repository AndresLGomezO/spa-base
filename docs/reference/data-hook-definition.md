...
| Document | Purpose |
|----------|---------|
| [data-hooks.md](../guides/data-hooks.md) | Product overview and phasing summary |
| [hooks-system-guide.md](../guides/hooks-system.md) | Hook dispatch architecture (system + dynamic hooks) |
| [entity-definition-json.md](./entity-definition.md) | Entity catalog JSON — hooks reference entity and field names |
...
1. Import or define **entities** first ([entity-definition-json.md](./entity-definition.md)).
