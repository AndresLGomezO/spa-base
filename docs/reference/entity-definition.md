...
| Document | Purpose |
|----------|---------|
| [dynamic-entity-builder-guide.md](../guides/dynamic-entity-builder.md) | Model Builder UI, permissions, evolution rules overview |
...
| [UI Design Manual](../ui-design-manual/README.md) | **UI layout** overrides per entity — not entity definitions |
| [relational-data-system-guide.md](../guides/relational-data-system.md) | How relation fields behave at runtime |
...
6. Configure UI layouts separately via the [UI Design Manual](../ui-design-manual/README.md) if needed.
