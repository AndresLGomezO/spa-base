...
| Document | Purpose |
|----------|---------|
| [query-engine-guide.md](../guides/query-engine.md) | Runtime list `?query=` JSON, filter tree shape, RBAC |
| [entity-definition-json.md](./entity-definition.md) | Entity catalog JSON — queries reference `sourceEntity` names |
| [metric-definition-json.md](./metric-definition.md) | Metrics JSON — optional `sourceQueryDefinitionId` references queries from this catalog |
