...
| Document | Purpose |
|----------|---------|
| [entity-query-definition-json.md](./entity-query-definition.md) | Saved queries referenced by `entityQueryDefinitionName` |
| [entity-definition-json.md](./entity-definition.md) | Entity catalog — custom views inherit `sourceEntity` from queries |
