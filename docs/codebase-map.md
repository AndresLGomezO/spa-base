...
| [apps/web/app/components/entity/EntityTable.tsx](../apps/web/app/components/entity/EntityTable.tsx) | Virtualized table + filters |
...
| File | Purpose |
|------|---------|
| [packages/hooks/src/execute-hooks.ts](../packages/hooks/src/execute-hooks.ts) | Hook runner |
...
| [apps/web/app/components/hooks/HookManager.tsx](../apps/web/app/components/hooks/HookManager.tsx) | Admin UI |
